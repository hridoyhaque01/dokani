...
function UserTable({ data }) {
  ...
  return (
    <div className="h-full overflow-auto flex flex-col items-end justify-between gap-4">
      <table className="table w-full">
        <thead className=" p-0">
          <tr className="font-bold  text-3xl text-blackHigh">
            ...
            <th className="bg-themeSemi text-base normal-case">Name</th>
            <th className="bg-themeSemi text-base normal-case">Email</th>
            <th className="bg-themeSemi text-base normal-case">Points</th>
            <th className="bg-themeSemi text-base normal-case">Uploads</th>
